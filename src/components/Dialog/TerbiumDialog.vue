...
<div>
    ...
    <q-dialog v-model="terbiumModal" persistent transition-show="scale" transition-hide="jump-up">
      <q-card style="width: 300px" class="q-px-sm q-pb-md">
        ...
        <q-space />
         ...
         <q-card-section class="row items-center justify-between q-pa-md q-ma-md">
          ...
          <q-btn size="xl" icon="opacity" color="positive" @click="resetPlayer"  round dense v-close-popup />
         ...
         <q-card-section class="row items-center justify-between q-pa-md q-ma-md">
          ...
          <q-btn size="xl" icon="close" @click="moveTerbiumCube" round dense v-close-popup />
