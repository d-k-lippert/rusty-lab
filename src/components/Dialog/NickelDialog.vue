      ...
      <q-card style="width: 300px" class="q-px-sm q-pb-md">
        ...
        <q-space />
         ...
         <q-card-section class="row items-center justify-between q-pa-md q-ma-md">
          <q-btn size="xl" label="N" color="blue" @click="resetPlayer" round dense v-close-popup />
          <q-btn size="xl" icon="anchor" color="positive" @click="resetPlayer"  round dense v-close-popup />
          <q-btn size="xl" icon="anchor" color="warning" @click="resetPlayer"  round dense v-close-popup />
        </q-card-section>
         <q-card-section class="row items-center justify-between q-pa-md q-ma-md">
